...
@Component("updateStockPriceRequestBuilder")
public class UpdateStockPriceRequestBuilder extends AbstractRequestBuilder {
	...
	public List<Request> getRequests() {
		...
		// List<StockInfo> list = stockInfoService.find(Criteria
		// .where(CommonConstant.CODE_STOCKINFO_COLUMN_NAME).not()
		// .is("000001"));
